...
import { validateEmail, validatePhone, validateAadhaar, validatePAN, validateIFSC, validateBankAccount } from '@/lib/validators';
import { ensureEmployeeColumns } from '@/lib/employee-schema-sync';
...
function parseStatusFilter(status: string | null): string | { in: string[] } | undefined {
      ...
      try {
        ...
        for (const tenant of visibleTenants) {
          ...
          try {
            ...
            if (statusFilter) empFilter.status = statusFilter;
