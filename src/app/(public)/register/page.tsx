...
import { getTenantLoginPath, getTenantLoginUrl, getTenantSubdomainLoginUrl } from '@/lib/tenant-client';
          ...
          <div className="p-8 space-y-6">
            ...
            <div className="bg-green-50 rounded-xl p-5">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div><span className="text-green-600">Login URL:</span> <span className="font-mono text-sm">{getTenantLoginUrl(registrationCode)}</span></div>
                <div><span className="text-green-600">Branded URL:</span> <span className="font-mono text-sm text-gray-500">{getTenantSubdomainLoginUrl(registrationCode)}</span></div>
              ...
              <div className="bg-emerald-50 border-2 border-emerald-200 rounded-xl p-5">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex items-center gap-2 bg-white p-3 rounded-lg border">
                    ...
                    <span className="font-mono text-sm text-emerald-700">{getTenantLoginUrl(registrationCode)}</span>
                  </div>
                </div>
            ...
            <div className="flex gap-3">
              {autoApproved ? (
                <button
                  onClick={() => router.push(getTenantLoginPath(registrationCode))}
                ...
                <div className="flex-1 py-3 px-6 bg-amber-50 border border-amber-200 text-amber-900 rounded-xl text-sm">
                  <p className="font-semibold">Pending super admin approval</p>
                  <p className="text-amber-700 mt-1">
                    After approval, log in at{' '}
                    <span className="font-mono text-xs">{getTenantLoginUrl(registrationCode)}</span>
                  </p>
                </div>
              )}
              <button
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                {codeAvailable === true && (
                  <p className="text-xs text-green-600 mt-1">✓ Available — login URL: {getTenantLoginUrl(form.companyCode)}</p>
                )}
                {codeAvailable === false && (
