export default function RootLoading() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--nexus-background)]">
      <div className="text-center">
        ...
        <p className="text-sm text-[var(--nexus-text-secondary)] font-medium">Loading...</p>
      </div>
    </div>
  );
}
