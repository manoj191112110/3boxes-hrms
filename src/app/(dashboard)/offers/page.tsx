...
import {
  FiPlus, FiX, FiCheck, FiFileText, FiEye, FiEdit2, FiTrash2,
} from 'react-icons/fi';
...
interface Offer {
  id: string; candidateName: string; candidateEmail: string; position: string; department: string | null; offeredSalary: number; offeredCurrency: string; joiningDate: string; probationPeriod: number; status: string; createdAt: string;
}
        ...
        <div id="crud-form" className="thb-card border-l-4 border-l-green-500">
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-xs font-medium text-thb-text-secondary mb-1">Salary *</label>
              ...
              <div>
                <label className="block text-xs font-medium text-thb-text-secondary mb-1">Joining Date *</label>
