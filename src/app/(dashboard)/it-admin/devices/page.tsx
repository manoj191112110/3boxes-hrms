      ...
      {showForm && (
        <div className="thb-card p-4 md:p-6 border-l-4 border-l-thb-primary animate-fade-in">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <div>
              <label className="text-xs font-medium text-thb-text-secondary mb-1 block">Device Name *</label>
            ...
            <div>
              <label className="text-xs font-medium text-thb-text-secondary mb-1 block">Serial Number *</label>
