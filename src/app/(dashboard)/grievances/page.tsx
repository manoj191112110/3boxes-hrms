        ...
        <div id="crud-form" className="thb-card border-l-4 border-l-green-500">
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-xs font-medium text-thb-text-secondary mb-1">Type <span className="text-red-500 font-bold">*</span></label>
              ...
              <div>
                <label className="block text-xs font-medium text-thb-text-secondary mb-1">Priority <span className="text-red-500 font-bold">*</span></label>
              ...
              <div className="sm:col-span-2 lg:col-span-3">
                <label className="block text-xs font-medium text-thb-text-secondary mb-1">Subject <span className="text-red-500 font-bold">*</span></label>
