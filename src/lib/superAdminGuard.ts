...
/**
 * Returns the JWT payload when the caller is super_admin; otherwise null.
 * Use in API routes that must be restricted to platform super admins only.
 */
export async function requireSuperAdmin(request: Request): Promise<SuperAdminPayload | null> {
