 ...
 * - Updates tenant logo
 * 
 * Usage: node scripts/update-production-logos.js
 */
...
async function main() {
  ...
  const adminUsers = [
    { email: 'admin@marqaitech.com', name: 'Admin - MARQ AI TECH', companyCode: 'MATPL', role: 'company_hr_admin' },
    { email: 'admin@3boxesluxury.com', name: 'Admin - 3 BOXES LUXURY', companyCode: '3BLC', role: 'company_hr_admin' },
    { email: 'admin@3boxesconsulting.com', name: 'Admin - 3 BOXES CONSULTING', companyCode: '3BCS', role: 'company_hr_admin' },
    { email: 'admin@3boxestechnologies.com', name: 'Admin - 3 BOXES TECHNOLOGIES', companyCode: '3BT', role: 'company_hr_admin' },
  ];
